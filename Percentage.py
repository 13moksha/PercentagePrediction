 ...
 "cells": [
  {
   ...
   "metadata": {},
   "source": [
    "# Moksha Dave-Data Science Task1"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    "url = \"https://raw.githubusercontent.com/PersonalWorks/Random/master/student_scores%20-%20student_scores.csv\"\n",
    "df = pd.read_csv(url)\n",
